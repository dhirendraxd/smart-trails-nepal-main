...
const destinations = [
  { name: "Kathmandu Valley", img: destKathmandu, category: "Heritage & Culture" },
  { name: "Pokhara", img: destPokhara, category: "Lake & Mountains" },
  { name: "Everest Region", img: destEverest, category: "Trekking & Adventure" },
  { name: "Chitwan", img: destChitwan, category: "Wildlife Safari" },
  { name: "Annapurna Circuit", img: destAnnapurna, category: "Trekking" },
  { name: "Lumbini", img: destLumbini, category: "Spiritual Pilgrimage" },
];
