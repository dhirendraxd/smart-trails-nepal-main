...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    img: destEverest,
    category: "Popular Trekking Route",
    coords: [28.005, 86.857],
    area: "Khumbu Region",
    crowd: "Busy",
    bestSeason: "Apr–May",
    budgetPerDayUsd: "$80–$130",
    budgetPerDayNpr: "NPR 10,500–17,200",
    altitudeM: 5364,
    difficulty: "Challenging",
    gallery: [
      {
        id: "ebc-khumbu-icefall",
        src: destEverest,
        locationName: "Khumbu Icefall Viewpoint",
        bestViewTime: "Early morning",
        crowd: "Busy",
      },
      {
        id: "ebc-gorakshep",
        src: destAnnapurna,
        locationName: "Gorak Shep Ridge",
        bestViewTime: "Sunrise",
        crowd: "Moderate",
      },
      {
        id: "ebc-kalapatthar",
        src: destPokhara,
        locationName: "Kala Patthar Summit",
        bestViewTime: "Sunrise on clear days",
        crowd: "Busy",
      },
      {
        id: "ebc-namche",
        src: destKathmandu,
        locationName: "Namche Bazaar Trail",
        bestViewTime: "Late morning",
        crowd: "Moderate",
      },
    ],
  },
  {
    ...
    name: "Rara Lake",
    img: destChitwan,
    category: "Hidden Gem Trek",
    coords: [29.528, 82.074],
    area: "Mugu Region",
    crowd: "Quiet",
    bestSeason: "Sep–Nov",
    budgetPerDayUsd: "$40–$65",
    budgetPerDayNpr: "NPR 5,300–8,600",
    altitudeM: 2990,
    difficulty: "Moderate",
    gallery: [
      {
        id: "rara-east-shore",
        src: destLumbini,
        locationName: "East Shore Viewpoint",
        bestViewTime: "Sunrise",
        crowd: "Quiet",
      },
      {
        id: "rara-murma-top",
        src: destAnnapurna,
        locationName: "Murma Top",
        bestViewTime: "Late afternoon",
        crowd: "Quiet",
      },
      {
        id: "rara-talcha-trail",
        src: destPokhara,
        locationName: "Talcha Access Trail",
        bestViewTime: "Morning",
        crowd: "Quiet",
      },
      {
        id: "rara-forest-path",
        src: destChitwan,
        locationName: "Rara Forest Crossing",
        bestViewTime: "Early morning",
        crowd: "Quiet",
      },
    ],
